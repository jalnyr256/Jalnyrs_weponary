...
public class Elite Knight<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "elite_knight"), "main");
	private final ModelPart elite_knight;
	...
	public Elite Knight(ModelPart root) {
		this.elite_knight = root.getChild("elite_knight");
		this.body = this.elite_knight.getChild("body");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition elite_knight = partdefinition.addOrReplaceChild("elite_knight", CubeListBuilder.create(), PartPose.offset(-7.0F, 24.0F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		elite_knight.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}