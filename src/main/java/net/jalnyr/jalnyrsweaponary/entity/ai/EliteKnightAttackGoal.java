...
public class EliteKnightAttackGoal extends MeleeAttackGoal {
    protected final EliteKnightEntity mob;
    ...
    public EliteKnightAttackGoal(EliteKnightEntity p_25552_, double p_25553_, boolean p_25554_) {
    ...
    protected double getAttackReachSqr(LivingEntity p_25556_) {
        ...
        return (double)(f * 4F * f * 4F + p_25556_.getBbWidth());
    }
}
