    ...
    public static final RegistryObject<CreativeModeTab> JALNYRSWEAPONARY = CREATIVE_MODE_TABS.register("jalnyrsweaponary",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.FROSTSTEEL_SWORD.get()))
                    ...
                    .displayItems((pParametres, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.ELITE_KNIGHT_SWORD.get());
                        ...
                        pOutput.accept(ModItems.ELITE_KNIGHT_SPAWN_EGG.get());
                        ...
                        pOutput.accept(ModItems.CRETACEOUS_DUAL_BLADE.get());
                        pOutput.accept(ModItems.CRETACEOUS_FRAGMENT.get());
                        pOutput.accept(ModItems.CRETACEOUS_SMITHING_TEMPLATE.get());

                        pOutput.accept(ModBlocks.DRIED_GRASS_BLOCK.get());
                        pOutput.accept(ModBlocks.BURNED_WOOD.get());
                        pOutput.accept(ModBlocks.BURNED_LOG.get());
                    })
                    .build());
