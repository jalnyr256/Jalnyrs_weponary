...
public class ModDimensions {
    ...
    public static final ResourceKey<Level> FALLENDIM_LEVEL_KEY = ResourceKey.create(Registries.DIMENSION,
            new ResourceLocation(JalnyrsWeaponary.MOD_ID, "fallendim"));
    public static final ResourceKey<DimensionType> FALLEN_DIM_TYPE = ResourceKey.create(Registries.DIMENSION_TYPE,
            new ResourceLocation(JalnyrsWeaponary.MOD_ID, "fallendim_type"));
    ...
    public static void bootstrapStem(BootstapContext<LevelStem> context) {
        ...
        NoiseBasedChunkGenerator wrappedChunkGenerator = new NoiseBasedChunkGenerator(
                new FixedBiomeSource(biomeRegistry.getOrThrow(ModBiomes.DRIED_PLAINS)),
                noiseGenSettings.getOrThrow(NoiseGeneratorSettings.OVERWORLD));

        NoiseBasedChunkGenerator noiseBasedChunkGenerator = new NoiseBasedChunkGenerator(
                MultiNoiseBiomeSource.createFromList(
                        new Climate.ParameterList<>(List.of(Pair.of(
                                        Climate.parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(ModBiomes.DRIED_PLAINS)),
                                Pair.of(
        ...
        LevelStem stem = new LevelStem(dimTypes.getOrThrow(ModDimensions.FALLEN_DIM_TYPE), wrappedChunkGenerator);

        context.register(FALLENDIM_KEY, stem);
    }
}
