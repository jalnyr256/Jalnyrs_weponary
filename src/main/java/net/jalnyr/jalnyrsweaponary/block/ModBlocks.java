...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BURNED_LOG = registerBlock("burned_log",
            () -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> BURNED_WOOD = registerBlock("burned_wood",
    ...
    public static final RegistryObject<Block> BURNED_SAPLING = registerBlock("burned_sapling",
            () -> new SaplingBlock(new BurnedTreeGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING)));
